...
//   const BookChoiceView({super.key, this.listNames});
...
//     final book = ModalRoute.of(context)!.settings.arguments as BookModelToo;
...
//                     itemCount: book.subBooks?.length ?? 0,
//                     itemBuilder: (context, index) {
//                       final subBook = book.subBooks![index];
//                       return ContainerTextWidget(
//                         width: width,
//                         height: height,
//                         text: subBook.subBook,
//                         onTap: () {
//                           Navigator.pushNamed(
//                             context,
