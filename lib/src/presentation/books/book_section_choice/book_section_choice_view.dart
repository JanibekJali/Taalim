...
class BookSectionChoiceView extends StatelessWidget {
  final String bookId;
  final String bookChoiceId;
  final String bookSectionId;
  final String title;
  const BookSectionChoiceView({
    Key? key,
  ...
  Widget build(BuildContext context) {
    context.read<BooksCubit>().fetchNestedCollection(
        'book/$bookId/book_choice/$bookChoiceId/book_section/$bookSectionId/book_section_choice');
                          ...
                          return ContainerTextWidget(
                            ...
                            onTap: () {
                              ...
                              Navigator.pushNamed(context,
                                  AppRoutesPath.bookSectionChoiceSection,
                                  arguments: {
                                    'title': item.title,
                                    'bookId': bookId,
                                    'bookChoiceId': bookChoiceId,
                                    'bookSectionId': bookSectionId,
                                    'bookSectionChoiceId': item.id,
                                  });
                            },
                          );
                        },
